func what_is_recursive_function(_ times: Int, _ line_repeat: Int) {
        let lines = String(repeating: "____", count: line_repeat)
        ...
        what_is_recursive_function(times-1, line_repeat+1)
        print("\(lines)라고 답변하였지.")
}

let n = Int(readLine()!)!
print("어느 한 컴퓨터공학과 학생이 유명한 교수님을 찾아가 물었다.")
what_is_recursive_function(n, 0)